              ...
              <div class="app-brand justify-content-center">
                <a href="{{ route('login') }}" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <image src="{{ asset('images/logo.png') }}" style="width: auto" alt="bkash"/>
                  </span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2 text-center">Welcome to BaisBD Panel👋</h4>
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    value="admin@b2m-tech.com" required autocomplete="email" autofocus
                  />
                    @error('email')
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input
                      type="password"
                      id="password" value="admin@b2m-tech.com"
