            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Create a new Sales</h3>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row">
...
export default {
    ...
    setup() {
        ...
        const productAddedQty = (id) => {
            ...
            var GET_productAttributes = productAttributes.value.find(
                (item) => item.id == id
            );

            if (
                parseInt(GET_productCustomization.qty) >=
                parseInt(GET_productAttributes.current_stock)
            ) {
                Toastr.fire({
                    icon: "error",
                    title: "Out of stock current stock",
                });
                return false;
            }
            ...
            GET_productCustomization.total =
                (GET_productCustomization.sales_price -
        ...
        const GETQtyInputValue = (e) => {
            ...
            if (
                ...
                e.target.value = GET_productAttributes.current_stock;
                return false;
            }
        ...
        const updateCustomizationData = (getProductCustomization) => {
            ...
            if (
                ...
                parseFloat(getProductCustomization.sales_price)
            ) {
                Toastr.fire({
                    icon: "error",
        ...
        const handleSubmit = () => {
            ...
            axios.post("/sales/create", data).then((response) => {
                const data = response.data.data;
