            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Update Return Purchase</h3>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row">
...
export default {
    setup() {
        ...
        const fetchData = () => {
            ...
            axios.get(`/purchase/return/fetch/${id}`).then((response) => {
                const data = response.data.data;
                getdata.value = data;
                paid_amount.value = data.purchaseReturn.return_amount;
                due_amount.value = data.purchaseReturn.due_amount;
                note.value = data.purchaseReturn.note;
                selected_transaction_type.value = 1;
                invoice_date.value = data.purchaseReturn.invoice_date;
                if (data.purchaseReturnDetails.length > 0) {
                    data.purchaseReturnDetails.map((item) => {
                        const SET_VALUE = {
                            id: item.id,
        ...
        const fetchSuppliers = () => {
            axios.get("/supplier/fetch").then((response) => {
                ...
                selectedSupplier.value =
                    getdata.value?.purchaseReturn?.supplier_id;
            });
        };
        ...
        const handleSubmit = () => {
            ...
            const data = {
                purchase_return_id: window.getId(),
         ...
         handleSubmitName.value = "Prosessing ...";
            ...
            axios
                .put(`/purchase/return/${data.purchase_return_id}/edit/`, data)
                .then((response) => {
                    const data = response.data.data;
