<template>
    <section class="content">
        ...
        <show-return-details-component
            ...
            :purchaseReturnEditLink="purchaseReturnEditLink"
        ></show-return-details-component>
    </section>
</template>
<style>
...
var purchaseReturnEditLink = ref("");

const fetchData = () => {
    axios.get("/purchase/return/list?type=fetch").then(function (response) {
            ...
            GET_DATA.map(function (item, index) {
                ...
                const btns = `
                    <div class="btn-group">
                        ...
                        <a href="/purchase/return/invoice/${item.id}" type="button" class="btn btn-primary btn-sm print btn-fit">
...
const fetchDetailsPurchaseData = (id) => {
    axios.get(`/purchase/return/fetch/${id}`).then((response) => {
        ...
        const modalElement = document.getElementById(
            "showReturnPurchaseDetails"
        );
        purchaseReturnEditLink.value = `/purchase/return/${id}/edit/`;
