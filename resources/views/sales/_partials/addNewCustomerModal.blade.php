<div class="modal fade" id="addNewCustomerModal" tabindex="-1" role="dialog" aria-labelledby="addNewCustomerModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title" id="addNewCustomerModalLabel">
                    Add New Customer
                </h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal" id="addNewCustomerSubmitBtn">
                    Submit
                </button>
            </div>
        </div>
