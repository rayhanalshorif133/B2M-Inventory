        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <div class="loging-register-btn-mobile">
              ...
              <li class="dropdown_item-1"> <a href="login.html" value="0" id="login" class="scrollto">Login </a>
              </li>
              <li class="dropdown_item-2"><a href="signup.html" id="signup" class="scrollto"> Sign Up </a></li>

            </div>
          </ul>
          <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
        </nav>
        <!--<div class="access-btn" id="accessBtn" value="{{ Auth::check() }}"><div></div>-->

        <ul class="loging-register-btn">
          <li class="dropdown_item-1"> <a href="{{ route('auth.login') }}" value="0" id="login" class="scrollto">Login </a>
          </li>
          <li class="dropdown_item-2"><a href="{{ route('auth.register') }}" id="signup" class="scrollto"> Sign Up </a></li>
        </ul>
      </div>
    </div>
  </header> <!-- End Header -->
        ...
        <div class="carousel-item active">
          ...
          <div class="carousel-container">
            ...
            <div class="start-more-btn">
              <a href="#" class="btn-get-started">Get Started <i class="fas fa-arrow-right"></i> </a>
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-md-6 align-content-center">
            <img src="{{ asset('new_assets/img/left-img.png')}}" class="img-fluid text-center" alt="">
          </div>
          <div class="col-md-6 content">
            <img src="{{ asset('new_assets/img/right-img.png')}}" class="img-fluid text-center" alt="">
          </div>
        </div>
    ...
    <section id="service" class="service-section section">
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-md-6 content">
            <img src="{{ asset('new_assets/img/service-right.png')}}" class="img-fluid text-center" alt="">
          </div>
        </div>
