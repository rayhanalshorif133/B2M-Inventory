    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item @if ($currentRouteName == 'sales.index' || $currentRouteName == 'sales.create' || $currentRouteName == 'sales.return.create' || $currentRouteName == 'payment.sales.pay' || $currentRouteName == 'sales.payment-list' || $currentRouteName == 'sales.return.index' || $currentRouteName == 'sales.due-collection') menu-is-opening menu-open @endif">
                    <a href="#" class="nav-link @if ($currentRouteName == 'sales.index' || $currentRouteName == 'sales.create' || $currentRouteName == 'sales.return.create' || $currentRouteName == 'sales.payment-list' || $currentRouteName == 'sales.return.index' || $currentRouteName == 'sales.due-collection' || $currentRouteName == 'payment.sales.pay') active menu-open @endif">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('sales.return.index') }}" class="nav-link @if ($currentRouteName == 'sales.return.index') active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Sales Return List</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sales.due-collection') }}" class="nav-link @if ($currentRouteName == 'sales.due-collection')
                               active
                            @endif">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('payment.sales.pay') }}" class="nav-link @if ($currentRouteName == 'payment.sales.pay')
                               active
                            @endif">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('sales.payment-list') }}" class="nav-link @if ($currentRouteName == 'sales.payment-list')
                               active
                            @endif">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link" id="sidebar_open_purchase">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ request()->has('tour') ? '/payment/purchase/pay?tour=going' : '/payment/purchase/pay' }}">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ request()->has('tour') ? '/purchase/payment-list?tour=going' : '/purchase/payment-list' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/expense-income/" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Entry & List</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/expense-income/category" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Category</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/expense-income/head" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Head</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="fa-solid text-cyan fa-clipboard-list mx-2" style="font-size: 1.3rem"></i>
                        <p>
                            Inventory
                            <i class="fas fa-angle-left right"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/report/current-stock" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Stock Report</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/report/profit-loss" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Profit & Loss</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/report/purchase" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Purchase Report</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/report/purchase-return" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Purchase Report Return</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/report/purchase-payment" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="/report/sales-return" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Sales Return Report</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/report/sales-payment" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Sales Payment</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/ledger/customer" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Customer</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/transaction-types" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
