        ...
        <div class="sm:px-3 md:px-4 xl:px-5">
            ...
            <div class="flex justify-between" :class="marginTopClass">
                ...
                <div class="mt-2 text-right">
                    ...
                    <p class="text-sm font-normal">
                        Generated By: {{ purchaseReturn.created_by.name }}
                    </p>
                    <p class="text-sm font-normal">
                        Generated at: {{ purchaseReturn.invoice_date }}
                    </p>
                </div>
            </div>
            <div class="mt-5">
                <table class="w-full mt-10">
                    ...
                    <tbody class="px-2 w-full">
                        ...
                        >
                            ...
                            <td class="p-2 text-right">{{ item.return_qty }}</td>
                            <td class="p-2 text-right">
                        ...
                        <tr class="px-3">
                            ...
                            <td class="text-right" colspan="3">
                                <span class="pr-10 text-base font-bold"
                                    >Sub total:</span
                                >
                                Tk. {{ purchaseReturn.total_amount }}
                            </td>
                        </tr>
                        <tr class="px-3">
                            <td class="p-2 text-right" colspan="3">
                                <div class="d-flex justify-content-end">
                                    ...
                                    <p>Tk. {{ purchaseReturn.return_amount }}</p>
                                </div>
                            </td>
                        </tr>
                        <tr class="px-3">
                            <td class="p-2 text-right" colspan="3">
                                ...
                                Tk.
                                {{
                                    purchaseReturn.total_amount - purchaseReturn.return_amount
                                }}
                            </td>
                        </tr>
                        <tr class="px-3">
                            ...
                            <td class="pt-1 text-right px-2" colspan="3">
                                <span class="text-left font-semibold">
                                    Return By : {{ purchaseReturn.created_by.name }}
                                </span>
                            </td>
                        </tr>
                    </tfoot>
...
export default {
    setup() {
        ...
        const fetchData = () => {
            ...
            var purchase_return_id = URL.split("/").reverse()[0];
            axios
                .get(`/purchase/return/invoice/${purchase_return_id}?fetch=true`)
                .then((response) => {
                    console.log(response.data.data);
                    purchaseReturn.value = response.data.data.purchaseReturn;
                    purchaseReturn.value.invoice_date = moment(
                        purchaseReturn.value.invoice_date
                    ).format("DD/MM/YYYY");
                    company.value = purchaseReturn.value.company;
                    supplier.value = purchaseReturn.value.supplier;
                    purchaseDetails.value = response.data.data.purchaseReturnDetails;
                    purchasePayment.value = response.data.data.purchaseReturnPayment;
                    purchasePayment.value.created_date = moment(
                        purchaseReturn.value.created_date
                    ).format("DD/MM/YYYY");
                });
        };
